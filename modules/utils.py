...
class MergeLayer(torch.nn.Module):
  def __init__(self, dim1, dim2, dim3, dim4):
    super().__init__()
    self.layer_norm = torch.nn.LayerNorm(dim1 + dim2) # 128+128
    self.fc1 = torch.nn.Linear(dim1 + dim2, dim3) # 256->128
    self.fc2 = torch.nn.Linear(dim3, dim4) # 128->128
...
class MergeLayer_output(torch.nn.Module):
  def __init__(self, dim1, dim2, dim3= 1024, dim4=1, drop_out=0.2):
    super().__init__()
    self.fc1 = torch.nn.Linear(dim1, dim3)  # 128 1024
    self.fc2 = torch.nn.Linear(dim3, dim3)  # 1024 1024
    self.fc3 = torch.nn.Linear(dim3, dim2)  # 1024 128
    self.fc4 = torch.nn.Linear(dim2 ,dim4 ) # 128 1
    self.act = torch.nn.ReLU()
...
class Feat_Process_Layer(torch.nn.Module):
  def __init__(self, dim1, dim2):
    super().__init__()
    self.fc1 = torch.nn.Linear(dim1, dim2)  # 172->128
    self.fc2 = torch.nn.Linear(dim2, dim2)  # 128->128
    self.act = torch.nn.ReLU()
